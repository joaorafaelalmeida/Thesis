...
%%% Edit author's name
%% Author's full name
\Author{Rafael\\Graça\\Moreira\\De\\Oliveira}

%%% Edit thesis title in Portuguese
%% Thesis Mandatory Title in Portuguese
\TitlePT{Um sistema de gestão de vulnerabilidades para avaliações de segurança em aplicações Web
aplicações web}
...
\TitleEN{A vulnerability management system for security assessments in web
applications}
...
\SupervisorMember{José Luis Oliveira}{Professor catedrático}{do Departamento de Eletrónica, Telecomunicações e Informática}{da Universidade de Aveiro}{}
...
\SupervisorMember{João Rafael Almeida}{Investigador auxiliar}{da Universidade de Aveiro}{}
...
\Dedication{Dedico este trabalho à minha família e amigos pelo incansável apoio.}

%%% OPTIONAL: Add an acknowledgement text
%% Optional Acknowledgement text
\Acknowledgements{Agradeço toda a ajuda a todos os meus colegas e companheiros que me acompanharam nesta jornada.}
